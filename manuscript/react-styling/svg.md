...
create-react-app 프로젝트에서 별도의 설정 없이 SVG를 쉽게 사용할 수 있습니다. 하지만 여러분이 웹팩 같은 빌드 도구와 함께 스크래치로 리액트 프로젝트를 만든다면 여러분이 직접 관리해야 하므로 다릅니다. SVG는 여러분의 애플리케이션을 좀 더 사용하기 쉽게 만들어 주기 때문에 적극적으로 사용하길 권장합니다.
